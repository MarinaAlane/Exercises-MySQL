...
SELECT title, IF('ACE GOLDFINGER', 'Já assisti a esse filme', 'Não conheço o filme') AS 'conheço o filme?'
FROM sakila.film;
...
SELECT
    ...
    CASE
        ...
        WHEN rating = 'Livre para todos' THEN 'Não recomendado para menores de 10 anos'
